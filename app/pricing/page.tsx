...
export const metadata = { title: 'Pricing — Post a Walk-in for Rs 100 | NCR Walk-in' };

export default function PricingPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-slate-900">Post a walk-in — Rs 100</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <div className="flex items-baseline gap-2">
          <span className="text-4xl font-bold text-emerald-700">Rs 100</span>
        ...
        <ul className="mt-5 space-y-3">
          {[
            ...
            'Renew for another 7 days at Rs 100',
          ].map((f) => (
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <p className="text-2xl font-bold text-slate-900">Rs 100</p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-slate-200 bg-white p-4">
            ...
            <p className="mt-1 text-sm text-slate-600">7 days from the date of payment. After that, it expires. You can renew for another 7 days at Rs 100.</p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-4">
